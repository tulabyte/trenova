...
if (isset($_GET['gtpay_tranx_id'])) {
  ...
  $updateSQL = sprintf("UPDATE gtpay_transaction SET gtpay_tranx_status_code = %s, gtpay_tranx_status_msg = %s WHERE gtpay_tranx_id = %s",
  ...
  $Result3 = mysql_query($updateSQL, $dbconn) or die('Update Payment Query:'. mysql_error());
    ...
    if($gtpay_tranx_status_code == '00') {
        ...
        //successful payment
        //notify payee
        $subject = "Your FITC Training payment for Order #$pay_order_id was SUCCESSFUL!";
        $body = "
<p>Dear $user_fullname,</p>
<p>Your payment for <strong>Order #$pay_order_id</strong> on <strong>FITC Training Mobile App</strong> was SUCCESSFUL!</p>
...
<p>Regards,</p>
<p>FITC Training</p>";
        MySwiftMailer($config['sender'], 'FITC Training Mobile', [$user_email], $subject, $body);

        //notify admin
        $subject = "$user_fullname's payment for Order #$pay_order_id was SUCCESSFUL!";
        $body = "
<p>Hello,</p>
<p>$user_fullname's payment for <strong>Order #$pay_order_id</strong> on <strong>FITC Training Mobile</strong> was SUCCESSFUL!</p>
<p>GTPay Transaction Reference number is <strong>$gtpay_tranx_id</strong>.</p>
<p>You can access full registration details by logging into FITC Training Backend (http://fitc-ng.com/fitc-training)</p>
<p>Regards,</p>
<p>FITC Training</p>";
        MySwiftMailer($config['sender'], 'FITC Training Mobile', [$config['notify']], $subject, $body);

    } else {
        //die('payment failure');
        //failed payment
        //notify payee
        $subject = "Your FITC Training payment for Order #$pay_order_id FAILED!";
        $body = "
<p>Dear $user_fullname,</p>
<p>Unfortunately, your payment for <strong>Order #$pay_order_id</strong> on <strong>FITC Training Mobile App</strong> FAILED!</p>
<p>GTPay Transaction Reference number is <strong>$gtpay_tranx_id</strong>.</p>
<p>Reason for Failure: $gtpay_tranx_status_msg.</p>
<p>Regards,</p>
<p>FITC Training Team</p>";
        MySwiftMailer($config['sender'], 'FITC Training Mobile', [$user_email], $subject, $body);
        ...
        $body = "
<p>Hello,</p>
<p>$user_fullname's payment for <strong>Order #$pay_order_id</strong> on <strong>FITC Training Mobile</strong> FAILED!</p>
<p>GTPay Transaction Reference number is <strong>$gtpay_tranx_id</strong>.</p>
