<?php 
/* This file specifies the configuration constants for the application */
...
//***MUST END WITH A '/'
//$config['url'] = 'https://fitc-ng.com/fitc-training/pay-online/';
$config['url'] = 'localhost/lenova/trnova/pay-online/';
